...
- **Project browser** with linked conversations and project documents.
...
All parsing and rendering happens client-side in your browser. Your export data is never sent to a server.
